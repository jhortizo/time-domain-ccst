...
def main():
    geometry_type = "single_element"
    params = {"side": 1.0}
    force_reprocess = True
    cst_model = "cst_quad9_rot4"
    constraints_loads = "cantilever_support"  # this actualli does not matter, but is the case hardcoded for the single element
    ...
    plot_oscillatory_movement(
        ...
        n_plots=200,
        fps=1,
        savepath=IMAGES_FOLDER + "/single_element_ccst_fixed_cantilever_mode0_implicit.gif",
    )
